...
public class HawkularEnableWarTest extends HawkularSeleniumLocalWebDriver {
	...
	public void hawkularLogin()
		...
		HwkularEnableWarPage testEnable = new HwkularEnableWarPage(driver);
		testEnable.clickToEnableWar();
